...
<div class="card">
  <div class="card-header">
    <h5 class="card-title" data-i18n="Confidentiality">Confidentiality</h5>
...
include"inc/des/alert.php";
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasEcommerceCategoryList" aria-labelledby="offcanvasEcommerceCategoryListLabel">
    ...
    <div class="offcanvas-header py-4">
      <h5 id="offcanvasEcommerceCategoryListLabel" class="offcanvas-title"data-i18n="Add Confidentiality">Add confidentiality</h5>
    ...
    <div class="offcanvas-body border-top">
      <form class="pt-0" id="eCommerceCategoryListForm" action="inc/fun/confidentiality/insert.php" method="POST">
        <!-- Title -->
        <div class="mb-3">
          <label class="form-label" for="ecommerce-category-title" data-i18n="Name">Name</label>
          <input type="text" class="form-control" id="ecommerce-category-title" placeholder="Enter confidentiality" required name="name" aria-label="category title">
        </div>
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control lang_en" id="ecommerce-category-title" placeholder="Enter confidentiality" required name="name_en" aria-label="category title">
        </div>
  ...
  <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasEcommerceCategoryList1" aria-labelledby="offcanvasEcommerceCategoryListLabel">
    <!-- Offcanvas Header -->
    <div class="offcanvas-header py-4">
      <h5 id="offcanvasEcommerceCategoryListLabel" class="offcanvas-title" data-i18n="Edit Confidentiality">Edit Confidentiality</h5>
      <button type="button" class="btn-close bg-label-secondary text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
    </div>
    <!-- Offcanvas Body -->
    <div class="offcanvas-body border-top">
      <form class="pt-0" id="eCommerceCategoryListForm" action="inc/fun/confidentiality/update.php" method="POST">
        <!-- Title -->
        <div class="mb-3">
          <label class="form-label" for="ecommerce-category-title" data-i18n="Name">Name</label>
        ...
        <div class="mb-3">
          <label class="form-label" for="ecommerce-category-title" data-i18n="name_en">name en</label>
          <input type="text" class="form-control name_en lang_en" id="ecommerce-category-title" placeholder="Enter confidentiality" required name="name_en" aria-label="category title">
        </div>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="row">
<form method="post" action="inc/fun/confidentiality/delete.php">
...
<script type="text/javascript">
  ...
  <script type="text/javascript">
    ...
    $('#myTable').DataTable({
        "ajax": {
            "url": "inc/json/confidentiality.php", // ﻥاﻮﻨﻌﺑ ﻝﺪﺒﺘﺳا URL ﺕﺎﻧﺎﻴﺑ ﻰﻠﻋ ﻝﻮﺼﺤﻠﻟ JSON
            "dataSrc": "" // ﺭﺬﺟ ﻥﻭﺩ ﺮﺷﺎﺒﻣ ﻞﻜﺸﺑ ﻲﺗﺄﺗ ﺕﺎﻧﺎﻴﺒﻟا ﻥﻷ ﺔﻏﺭﺎﻓ ﻰﻟﺇ ﺎﻬﻨﻴﻴﻌﺗ ﺐﺠﻳ
        },


        // (`id`, `confidentiality_number`, `tarmez`, `confidentiality_id`, `confidentiality_id`, `confidentiality_id`, `subject`, `recipient_entity_id`, `user_id`, `confidentiality_date`)
...
?>
      ...
      <?php
        ...
        {
            text: '<i class="bx bx-plus me-0 me-sm-1"></i><span class="d-none d-sm-inline-block" data-i18n="Add Confidentiality">Add confidentiality</span>',
