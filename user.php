...
<div class="card">
  <div class="card-header">
    <h5 class="card-title" data-i18n="Users">Users</h5>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="row">
<form method="post" action="inc/fun/user/delete.php">
...
// console.log(filter)
  ...
  <script type="text/javascript">
    ...
    $('#myTable').DataTable({
        "ajax": {
            "url": "inc/json/user.php", // اﺳﺘﺒﺪﻝ ﺑﻌﻨﻮاﻥ URL ﻟﻠﺤﺼﻮﻝ ﻋﻠﻰ ﺑﻴﺎﻧﺎﺕ JSON
            "dataSrc": "" // ﻳﺠﺐ ﺗﻌﻴﻴﻨﻬﺎ ﺇﻟﻰ ﻓﺎﺭﻏﺔ ﻷﻥ اﻟﺒﻴﺎﻧﺎﺕ ﺗﺄﺗﻲ ﺑﺸﻜﻞ ﻣﺒﺎﺷﺮ ﺩﻭﻥ ﺟﺬﺭ
        },


        // (`id`, `user_number`, `tarmez`, `user_id`, `user_id`, `confidentiality_id`, `subject`, `recipient_entity_id`, `user_id`, `user_date`)
...
// console.log(s)
        ...
        , {
            ...
            render: function(t, e, s, a) {
                ...
                return `<img class="img-fluid rounded my-3" src="inc/fun/user/file/`+n+`" alt="`+s.name_ar+`" style="width:70px;height:70px" alt="User avatar">`
...
<?php if ($_COOKIE['lang']=="ar"){?>
                    ...
                    var n = s.company_name;
<?php
                     }else if ($_COOKIE['lang']=="en"){?>

                  var n = s.company_name_en;
                       <?php
                   }?>;
        ...
        , {
            ...
            render: function(t, e, s, a) {
                ...
                var n = s.phone;
                return `<a dir="ltr" href="tel:`+s.phone+`">`+s.phone+`</a>`
                return n;
...
?>
...

        {
            ...
            action: function() {
                window.location.href = "inc/des/user/print.php";
            }
        },  {
                extend: "pdf",
                ...
                action: function() {
                window.location.href = "inc/des/user/pdf.php";
            }
            } ]
        },
      ...
      <?php
         ...
         {
            text: '<i class="bx bx-plus me-0 me-sm-1"></i><span class="d-none d-sm-inline-block" data-i18n="Add User">Add User</span>',
            className: "add-new btn btn-primary",
            action: function() {
                window.location.href = "?add_user=show"
            }
        }],
///////////////////////////////////////////////////////////////////
