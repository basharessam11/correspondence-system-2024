        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
              <div class="card-header">
                <h5 class="card-title" data-i18n="Outgoing">Outgoing</h5>
...
<form method="post" action="inc/fun/outgoing/status.php">
                <div id="name" class=" col mb-3" data-i18n="Alert Delete">
                     ...
                     <input   type="hidden" name="page" value="outgoing1">
                        ...
                        render: function(t, e, s, a) {
                            ...
                            var n = s.user_id;
                              ...
                              <a href="?edit_outgoing=show&id=`+s.id+`">
                                ...
                                <a href="inc/des/outgoing/print2.php?id=`+s.id+`&page=outgoing1">
                                <button class="btn btn-sm btn-icon">
...
?>
            ...
            action: function() {
                window.location.href = "inc/des/outgoing/print1.php?status=0&page=outgoing1&date1="+$('#date1').val()+"&date2="+$('#date2').val();
            }
        },
            
              {
                            ...
                            className: "dropdown-item",
                             action: function() {
                window.location.href = "inc/des/outgoing/pdf1.php?status=0&page=outgoing1&date1="+$('#date1').val()+"&date2="+$('#date2').val();
            }
                        } ]
                    },
