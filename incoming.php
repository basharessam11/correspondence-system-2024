        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
              <div class="card-header">
                <h5 class="card-title" data-i18n="incoming">incoming</h5>
...
?>
            ...
            action: function() {
                window.location.href = "inc/des/incoming/print.php?status=0&page=incoming&date1="+$('#date1').val()+"&date2="+$('#date2').val();
            }
        },
            
                 {
                            ...
                            action: function() {
                window.location.href = "inc/des/incoming/pdf.php?status=0&page=incoming&date1="+$('#date1').val()+"&date2="+$('#date2').val();
            }
                        } ]
                    },
