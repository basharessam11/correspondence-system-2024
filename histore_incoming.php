        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card">
              <div class="card-header">
                <h5 class="card-title" data-i18n="histore_incoming">histore incoming</h5>
                ...
                <table  id="myTable" class="datatables-products table border-top">
                  <thead>
                    <tr>
                      ...
                      <th data-i18n="incoming number">incoming number</th>
                      <th style="width:80px" data-i18n="incoming date">incoming date</th>
                        ...
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <div class="row">
            <form method="post" action="inc/fun/incoming/delete.php">
               ...
               <!-- group delete -->
                      <div class="modal fade" id="basicModal3" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel1 " data-i18n="recovery">recovery</h5>
                              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                              <div class="row">
            <form method="post" action="inc/fun/incoming/status.php">
                            <div id="name" class=" col mb-3" data-i18n="alert recovery">
                     ...
                     <input   type="hidden" name="status" value="0">
                             ...
                             <div class="modal-footer">
                               <button type="button" class="btn btn-label-secondary" data-bs-dismiss="modal" data-i18n="Close">Close</button>
                               <button type="submit" class="btn btn-success" data-i18n="recovery">recovery</button>
            </form>
                            </div>
                          </div>
                        </div>
...
function search() {
     ...
     $('#myTable').DataTable({
        "destroy": true,
              "ajax": {
            "url": "inc/json/histore_incoming.php",
            "data": function(d) {
            ...
            "dataSrc": ""
                    ...
                    "columns": [
                        ...
                        // يمكنك إضافة المزيد من الأعمدة هنا حسب احتياجاتك
                    ]
                , 
                    columnDefs: [{
                        className: "control",
                    ...
                    , {
                        ...
                        render: function(t, e, s, a) {
                            ...
                            var n = s.user_id;
                              ...
                              <a href="?edit_incoming=show&id=`+s.id+`">
...
?>
{
        ...
        {
            text: '<i class="bx bx-trash"></i><span class="d-none d-sm-inline-block"><?php if ($_COOKIE['lang']=="ar"){echo 'إسترجاع';}else if ($_COOKIE['lang']=="en"){echo 'recovery';}?> </span>',
            className: "add-new btn btn-success de me-3",
            attr: {
          "data-bs-toggle": "modal",
...
?>
            ...
            action: function() {
                window.location.href = "inc/des/incoming/print.php?status=1&page=histore_incoming&date1="+$('#date1').val()+"&date2="+$('#date2').val();
            }
        },
            
                 {
                            ...
                            action: function() {
                window.location.href = "inc/des/incoming/pdf.php?status=1&page=histore_incoming&date1="+$('#date1').val()+"&date2="+$('#date2').val();
            }
                        } ]
                    },
             ...
             ?>
                    ...
                    //  {
                    //     text: '<i class="bx bx-plus me-0 me-sm-1"></i><span class="d-none d-sm-inline-block"  ><?php if ($_COOKIE['lang']=="ar"){echo 'إضافة وارد';}else if ($_COOKIE['lang']=="en"){echo 'Add incoming';}?></span>',
                    //     className: "add-new btn btn-primary",
                    //     action: function() {
                    //         window.location.href = "?add_incoming=show"
                    //     }
                    // }
                    ],
            ///////////////////////////////////////////////////////////////////
                responsive: {
                        details: {
                            display: $.fn.dataTable.Responsive.display.modal({
                                header: function(t) {
                                    return "Details of " + t.data().incoming_date
                                }
                            }),
                            type: "column",
