...
<br> 
  ...
  <div class="table-responsive mt-2" dir="<?php if ($_COOKIE['lang']=="ar"){echo 'rtl';}else if ($_COOKIE['lang']=="en"){  echo'ltr';} ?>">
    <table class="table table2 border-top m-0 table2" style="width: 100%;" >
      <thead>
         <tr class="table2">
...
<?php if ($_COOKIE['lang']=="ar"){echo 'الصورة';}else if ($_COOKIE['lang']=="en"){  echo'photo';} ?>
          </th>
...
<?php if ($_COOKIE['lang']=="ar"){echo 'الاسم';}else if ($_COOKIE['lang']=="en"){  echo'name';} ?>

          </th>
          <th class="table2" style="font-size: 12px; padding: 5px 5px 5px 5px; color:black;   font-weight: bold; text-align:center;background-color: #ccc;letter-spacing:0px; width: 350px;"  >
<?php if ($_COOKIE['lang']=="ar"){echo 'اسم الشركة';}else if ($_COOKIE['lang']=="en"){  echo'Company Name';} ?>

          </th>
          <th class="table2" style="font-size: 12px; padding: 5px 5px 5px 5px; color:black;   font-weight: bold; text-align:center;background-color: #ccc;letter-spacing:0px;"  >
<?php if ($_COOKIE['lang']=="ar"){echo 'الهاتف';}else if ($_COOKIE['lang']=="en"){  echo'phone';} ?>

         </th>
          <th class="table2" style="font-size: 12px; padding: 5px 5px 5px 5px; color:black;   font-weight: bold; text-align:center;background-color: #ccc;letter-spacing:0px;"  >
<?php if ($_COOKIE['lang']=="ar"){echo 'الحالة';}else if ($_COOKIE['lang']=="en"){  echo'status';} ?>
...
?>  
        <tr>
          <td class="table2" style="width:70px;font-size: 12px; padding: 5px 5px 5px 5px; color:black;  font-weight: bold; text-align:center"background-color: #ccc;><?=$x?></td>

          <td class="table2" style="width:90px;font-size: 12px; padding: 5px 5px 5px 5px; color:black;  font-weight: bold; text-align:center"background-color: #ccc;><img class="img-fluid rounded my-3" src="../../fun/user/file/<?=$row['file']?>" alt="<?=$row['name']?>" style="width:70px;height:70px" ></td>


          <td class="table2" style="width:70px; font-size: 12px; padding: 5px 5px 5px 5px; color:black;  font-weight: bold; text-align:center"background-color: #ccc;>
          ...
          <td class="table2" style="width:70px; font-size: 12px; padding: 5px 5px 5px 5px; color:black;  font-weight: bold; text-align:center"background-color: #ccc;>
<?php if ($_COOKIE['lang']=="ar"){echo $row['company_name'];}else if ($_COOKIE['lang']=="en"){echo $row['company_name_en'];}?>
</td>


          <td class="table2" style="font-size: 12px; padding: 5px 5px 5px 5px; color:black;  font-weight: bold; text-align:center"background-color: #ccc;><a href="tel:<?=$row['phone']?>"><?=$row['phone']?></a></td>



          <td class="table2" style="font-size: 12px; padding: 5px 5px 5px 5px; color:black;  font-weight: bold; text-align:center"background-color: #ccc;><?php
    ...
    xhr.responseType = 'blob';
      ...
      xhr.onload = function () {
        if (xhr.status === 200) {
            ...
            window.location.href = '../../../dashbord.php?user=show';
        }
    };
