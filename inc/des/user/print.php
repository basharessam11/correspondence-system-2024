...
<div class="invoice-print " <?php if ($_COOKIE['lang']=="ar"){echo 'style="padding: 0 0px 0 40px;"';}?>>
  ...
  <div class="table-responsive mt-2" dir="<?php if ($_COOKIE['lang']=="ar"){echo 'rtl';}else if ($_COOKIE['lang']=="en"){  echo'ltr';} ?>">
    <table class="table border-top m-0" style="width: 100%;">
         ...
         <tr>
          ...
          <th style="font-size: 12px; padding: 5px 5px 5px 5px; color:black;   font-weight: bold; text-align:center;background-color: #ccc;letter-spacing:0px;" data-i18n="photo">photo</th>

          <th style="font-size: 12px; padding: 5px 5px 5px 5px; color:black;   font-weight: bold; text-align:center;background-color: #ccc;letter-spacing:0px; width:  " data-i18n="name1">name</th>

          <th style="font-size: 12px; padding: 5px 5px 5px 5px; color:black;   font-weight: bold; text-align:center;background-color: #ccc;letter-spacing:0px; width:  " data-i18n="Company Name">Company Name</th>
...
?>  
        <tr>
          <td style="width:70px;font-size: 12px; padding: 5px 5px 5px 5px; color:black;  font-weight: bold; text-align:center"background-color: #ccc;><?=$x?></td>

          <td style="width:90px;font-size: 12px; padding: 5px 5px 5px 5px; color:black;  font-weight: bold; text-align:center"background-color: #ccc;><img class="img-fluid rounded my-3" src="../../fun/user/file/<?=$row['file']?>" alt="<?=$row['name']?>" style="width:70px;height:70px" ></td>


          <td style="width:70px; font-size: 12px; padding: 5px 5px 5px 5px; color:black;  font-weight: bold; text-align:center"background-color: #ccc;>

           <?php if ($_COOKIE['lang']=="ar"){echo $row['name'];}else if ($_COOKIE['lang']=="en"){echo $row['name_en'];}?>

        </td>

          <td style="width:270px; font-size: 12px; padding: 5px 5px 5px 5px; color:black;  font-weight: bold; text-align:center"background-color: #ccc;>
<?php if ($_COOKIE['lang']=="ar"){echo $row['company_name'];}else if ($_COOKIE['lang']=="en"){echo $row['company_name_en'];}?>
</td>


          <td style="font-size: 12px; padding: 5px 5px 5px 5px; color:black;  font-weight: bold; text-align:center"background-color: #ccc;><a href="tel:<?=$row['phone']?>"><?=$row['phone']?></a></td>



          <td style="font-size: 12px; padding: 5px 5px 5px 5px; color:black;  font-weight: bold; text-align:center"background-color: #ccc;><?php
