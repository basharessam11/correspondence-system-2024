  ...
  <div class="table-responsive mt-2" dir="<?php if ($_COOKIE['lang']=="ar"){echo 'rtl';}else if ($_COOKIE['lang']=="en"){  echo'ltr';} ?>">
    <table class="table border-top m-0" style="width: 100%;">
         ...
         <tr>
          ...
          <th style="font-size: 12px; padding: 5px 5px 5px 5px; color:black;   font-weight: bold; text-align:center;background-color: #ccc;letter-spacing:0px;" data-i18n="incoming number">incoming number</th>
          <th style="font-size: 12px; padding: 5px 5px 5px 5px; color:black;   font-weight: bold; text-align:center;background-color: #ccc;letter-spacing:0px;" data-i18n="incoming date">incoming date</th>
...
?>  
          ...
          <td style="width:90px;font-size: 12px; padding: 5px 5px 5px 5px; color:black;  font-weight: bold; text-align:center"><?=$row['incoming_date']?></td>
