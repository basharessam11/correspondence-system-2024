    ...
    <table class="table border-top m-0" style="width: 100%;">
      <thead>
         <tr>
          ...
          <th style="font-size: 12px; padding: 5px 5px 5px 5px; color:black;   font-weight: bold; text-align:center;background-color: #ccc;letter-spacing:0px; width: 100px;" data-i18n="Confidentiality">Confidentiality</th>

          <th style="font-size: 12px; padding: 5px 5px 5px 5px; color:black;   font-weight: bold; text-align:center;background-color: #ccc;letter-spacing:0px; width: 100px;" data-i18n="subject1">subject</th>
