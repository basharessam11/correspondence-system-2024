...
<head>
    ...
    <title data-i18n="Company">Company</title>
...
<?php if ($_COOKIE['lang']=="ar"){echo 'شعار';}else if ($_COOKIE['lang']=="en"){  echo'Logo';} ?>
          </th>
...
<?php if ($_COOKIE['lang']=="ar"){echo 'الهاتف';}else if ($_COOKIE['lang']=="en"){  echo'phone';} ?>
        ...
        <th class="table2" style="font-size: 12px; padding: 5px 5px 5px 5px; color:black;   font-weight: bold; text-align:center;background-color: #ccc;letter-spacing:0px;"  >
<?php if ($_COOKIE['lang']=="ar"){echo 'الفاكس';}else if ($_COOKIE['lang']=="en"){  echo'fax';} ?>

         </th>


                 <th class="table2" style="font-size: 12px; padding: 5px 5px 5px 5px; color:black;   font-weight: bold; text-align:center;background-color: #ccc;letter-spacing:0px;"  >
<?php if ($_COOKIE['lang']=="ar"){echo 'البريد الإلكتروني';}else if ($_COOKIE['lang']=="en"){  echo'email';} ?>

         </th>


                 <th class="table2" style="font-size: 12px; padding: 5px 5px 5px 5px; color:black;   font-weight: bold; text-align:center;background-color: #ccc;letter-spacing:0px;"  >
<?php if ($_COOKIE['lang']=="ar"){echo 'العنوان';}else if ($_COOKIE['lang']=="en"){  echo'Address';} ?>
...
?>  
         ...
         <tr>
          ...
          <td class="table2" style="width:90px;font-size: 12px; padding: 5px 5px 5px 5px; color:black;  font-weight: bold; text-align:center"><img class="img-fluid rounded my-3" src="../../fun/company/file/<?=$row['file']?>" alt="<?=$row['name']?>" style="width:70px;height:70px" ></td>
...
<?php if ($_COOKIE['lang']=="ar"){echo $row['name'];}else if ($_COOKIE['lang']=="en"){echo $row['name_en'];}?>
          ...
          <td class="table2" style="font-size: 12px; padding: 5px 5px 5px 5px; color:black;  font-weight: bold; text-align:center"><a href="tel:<?=$row['phone']?>"><?=$row['phone']?></a></td>

          <td class="table2" style="font-size: 12px; padding: 5px 5px 5px 5px; color:black;  font-weight: bold; text-align:center"><?=$row['fax']?></td>

          <td class="table2" style="font-size: 12px; padding: 5px 5px 5px 5px; color:black;  font-weight: bold; text-align:center"><a href="mailto:<?=$row['email']?>"><?=$row['email']?></a></td>
...
<?php if ($_COOKIE['lang']=="ar"){echo $row['address'];}else if ($_COOKIE['lang']=="en"){echo $row['address_en'];}?>
          ...
          <td class="table2" style="font-size: 12px; padding: 5px 5px 5px 5px; color:black;  font-weight: bold; text-align:center"><?php
  ...
  function pdf() {
    ...
    xhr.onload = function () {
        if (xhr.status === 200) {
            ...
            window.location.href = '../../../dashbord.php?company=show';
        }
    };
