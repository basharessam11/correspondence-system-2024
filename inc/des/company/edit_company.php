<?php
 ...
 $id=$_GET['id'];
$sql->selectall("company where id=$id ");
...
<div class="col-12">
    <div class="card">
      <h5 class="card-header" data-i18n="Edit Company">Edit Company</h5>
      <?php
...
<center> ﺗﻢ ﺗﻐﻴﻴﺮ اﺳﻢ اﻟﻤﻮﻗﻊ ﺑﻨﺠﺎﺡ</center>
 ...
 if (isset($_GET['error'])=='su') {
      ...
      <div class="card-body">
        ...
        <form   method="POST" action="inc/fun/company/update.php" class="row g-3 fv-plugins-bootstrap5 fv-plugins-framework" enctype="multipart/form-data" >
...
<!-- /////////////////////////////////////////////////////////////////////////////////////////// -->
     ...
     <label class="form-label" data-i18n="Name">name</label>
            ...
            <div class="input-group input-group-merge">
              ...
              <input type="text" id="basic-icon-default-company" value="<?=$row['name']?>" placeholder="<?php if ($_COOKIE['lang']=="ar"){echo 'الاسم بالعربية';}else if ($_COOKIE['lang']=="en"){  echo'NAME (ARABIC)';} ?>"  name="name" class="form-control" placeholder="ACME Inc." aria-label="ACME Inc." required aria-describedby="basic-icon-default-company2">
 ...
 <div class="col-md-6 fv-plugins-icon-container">
     ...
     <label class="form-label" data-i18n="name_en">Name </label>
           ...
           <div class="input-group input-group-merge">
              ...
              <input type="text" class="form-control lang_en" value="<?=$row['name_en']?>" placeholder="<?php if ($_COOKIE['lang']=="ar"){echo 'الاسم بالإنجليزية';}else if ($_COOKIE['lang']=="en"){  echo'NAME (ENGLISH)';} ?>" dir="ltr" name="name_en" id="basic-icon-default-fullname" placeholder="John Doe" aria-label="John Doe" aria-describedby="basic-icon-default-fullname2">
            </div>
...
<!-- /////////////////////////////////////////////////////////////////////////////////////////// -->
     ...
     <label class="form-label"   data-i18n="email">email</label>
            <div class="input-group input-group-merge">
              ...
              <input type="text" id="basic-icon-default-email" required class="form-control" placeholder="john.doe@example.com" aria-label="john.doe@example.com" value="<?=$row['email']?>" name="email" aria-describedby="basic-icon-default-email2">
             </div>
          </div>
<!-- /////////////////////////////////////////////////////////////////////////////////////////// -->
    <div class="col-md-6 fv-plugins-icon-container">
    ...
    <label class="form-label" data-i18n="fax">fax</label>
            <div class="input-group input-group-merge">
              ...
              <input type="text" id="basic-icon-default-fax" value="<?=$row['fax']?>" required name="fax" class="form-control" placeholder="Fax" aria-label="Fax" aria-describedby="basic-icon-default-Fax2">
            </div>
          </div>
<!-- /////////////////////////////////////////////////////////////////////////////////////////// -->
     <div class="col-md-6 fv-plugins-icon-container">
     ...
     <label class="form-label" data-i18n="URL">URL</label>
            <input type="text" id="formValidationName" value="<?=$row['url']?>" class="  form-control" name="url" required   placeholder="https://example.com">
          </div>
<!-- /////////////////////////////////////////////////////////////////////////////////////////// -->
          ...
          <label class="form-label" data-i18n="status">Status</label>
            <select  class="form-select hwafz select3" name="status"    >
              ...
              <option   <?php if ($row['status']==0) {echo 'selected';}?>  value="0" ><?php if ($_COOKIE['lang']=="ar"){echo 'غير نشط';}else if ($_COOKIE['lang']=="en"){echo 'inactive';}?></option>
...
<label class="form-label" data-i18n="Address_en">Address_en</label>
            <textarea name="address_en" dir="ltr" class="form-control lang_en" required id="collapsible-address_en" rows="2" placeholder="<?php if ($_COOKIE['lang']=="ar"){echo 'العنوان بالانجليزية';}else if ($_COOKIE['lang']=="en"){  echo'Address (ENGLISH)';} ?>"><?=$row['address_en']?></textarea>
          </div>
 <!-- /////////////////////////////////////////////////////////////////////////////////////////// -->
...
foreach ($e as $key => $value) {
  echo'<a target="_blank" href="inc/fun/company/file/'.$value.'""><img id="blah" style="width: 150px;height: 150px;padding: 5px;" src="inc/fun/company/file/'.$value.'" alt="your image" /></a>';
}
...
?>
  ...
  <input type="hidden"  name="file_last" value="<?=$row["file"]?>"  class="form-control">
