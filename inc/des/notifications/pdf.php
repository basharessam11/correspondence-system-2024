...
<head>
    ...
    <title data-i18n="notifications">notifications</title>
      ...
      <thead>
         <tr>
          ...
          <th class="table2" style="font-size: 12px; padding: 5px 5px 5px 5px; color:black;   font-weight: bold; text-align:center;background-color: #ccc;letter-spacing:0px;"    >
            <?php if ($_COOKIE['lang']=="ar"){echo 'اسم المستخدم  ';}else if ($_COOKIE['lang']=="en"){  echo'User Name';} ?>
          </th>

          
          <th style="font-size: 12px; padding: 5px 5px 5px 5px; color:black;   font-weight: bold; text-align:center;background-color: #ccc;letter-spacing:0px;  " >
<?php if ($_COOKIE['lang']=="ar"){echo 'الصفحة  ';}else if ($_COOKIE['lang']=="en"){  echo'page';} ?>
          </th>


          <th class="table2" style="font-size: 12px; padding: 5px 5px 5px 5px; color:black;   font-weight: bold; text-align:center;background-color: #ccc;letter-spacing:0px;"    >
<?php if ($_COOKIE['lang']=="ar"){echo 'الاشعارات   ';}else if ($_COOKIE['lang']=="en"){  echo'notifications';} ?>

          </th>


          <th class="table2" style="font-size: 12px; padding: 5px 5px 5px 5px; color:black;   font-weight: bold; text-align:center;background-color: #ccc;letter-spacing:0px;"   >
<?php if ($_COOKIE['lang']=="ar"){echo 'التاريخ   ';}else if ($_COOKIE['lang']=="en"){  echo'date';} ?>
 </th>
...
?>  
       ...
       <tr>
          <td class="table2" style="font-size: 12px; padding: 5px 5px 5px 5px; color:black;  font-weight: bold; text-align:center"><?=$x?></td>
...
<?php if ($_COOKIE['lang']=="ar"){echo $row['name']; echo ($row['permissions'] ==1 ) ? " (مدير) " : " (موظف) ";}else if ($_COOKIE['lang']=="en"){echo $row['name_en'];echo ($row['permissions'] ==1 ) ? " (Admin) " : " (Employe) ";}?>
           </td>


          <td class="table2" style="font-size: 12px; padding: 5px 5px 5px 5px; color:black;  font-weight: bold; text-align:center">

<?php if ($_COOKIE['lang']=="ar"){echo $row['page'];}else if ($_COOKIE['lang']=="en"){echo $row['page_en'];}?>

          </td>

          <td class="table2" style="font-size: 12px; padding: 5px 5px 5px 5px; color:black;  font-weight: bold; text-align:center">

<?php if ($_COOKIE['lang']=="ar"){echo $row['des'];}else if ($_COOKIE['lang']=="en"){echo $row['des_en'];}?>
  ...
  function pdf() {
    ...
    xhr.onload = function () {
        if (xhr.status === 200) {
            ...
            window.location.href = '../../../dashbord.php?notifications=show';
        }
    };
