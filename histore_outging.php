...
<div class="card">
  <div class="card-header">
    <h5 class="card-title" data-i18n="histore_outging">histore outging</h5>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="row">
<form method="post" action="inc/fun/outgoing/delete.php">
...
function search() {
     ...
     $('#myTable').DataTable({
        "destroy": true,
              "ajax": {
            "url": "inc/json/histore_outging.php",
            "data": function(d) {
...

{
            ...
            action: function() {
                window.location.href = "inc/des/outgoing/print.php?status=1&page=histore_outging&date1="+$('#date1').val()+"&date2="+$('#date2').val();
            }
        }
 ...
 , {
                ...
                className: "dropdown-item",
                    action: function() {
                window.location.href = "inc/des/outgoing/pdf.php?status=1&page=histore_outging&date1="+$('#date1').val()+"&date2="+$('#date2').val();
            }
            } ]
        },
