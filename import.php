...
$sql->selectall("backup_db order by id desc limit 1");
...
define("DB_USER", 'root');
define("DB_PASSWORD", '');
define("DB_NAME", 'sader');
define("DB_HOST", 'localhost');
define("BACKUP_DIR", 'myphp-backup-files'); // Comment this line to use same script's directory ('.')
define("BACKUP_FILE", $name.'.gz'); // Script will autodetect if backup file is gzipped based on .gz extension
define("CHARSET", 'utf8');
...
if (php_sapi_name() != "cli") {
 ...
 $sql->update('backup_db',["name"=>"$name"],"where id=$id");